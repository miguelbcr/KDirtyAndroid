 ...
 */
class FcmTokenReceiver : FcmRefreshTokenReceiver {

  override fun onTokenReceive(oTokenUpdate: Observable<TokenUpdate>) {
    oTokenUpdate.subscribe { tokenUpdate ->
      val baseApp = tokenUpdate.application as BaseApp
