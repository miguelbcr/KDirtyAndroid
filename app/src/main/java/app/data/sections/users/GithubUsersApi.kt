...
const val HEADER_API_VERSION : String = "Accept: application/vnd.github.v3+json"
...
interface GithubUsersApi {
    ...
    fun getUserByName(@Valid(value = STRING, legal = "google") @Path("username") username: String): Single<Response<User>>
