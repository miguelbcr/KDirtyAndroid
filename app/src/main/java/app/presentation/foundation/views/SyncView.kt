 ...
 */
@Singleton
class SyncView @Inject internal constructor() {
  private val pendingScreens: MutableList<String>

  init {
    this.pendingScreens = ArrayList()
  }
  ...
  fun needToSync(matcher: Matcher): Boolean {
    ...
    if (needToSync) pendingScreens.removeAt(index)
    return needToSync
  }

  interface Matcher {
    fun matchesTarget(key: String): Boolean
  }
}
